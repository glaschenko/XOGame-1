...
public class GameMap extends JPanel implements TTGameListener {
    ...
    private void render(Graphics g) {
        ...
        cellWidth = width / game.getSettings().getFieldSize();
        cellHeight = height / game.getSettings().getFieldSize();
    ...
    private void drawPlayerSymbols(Graphics g){
        for (int y = 0; y < game.getSettings().getFieldSize(); y++) {
            for (int x = 0; x < game.getSettings().getFieldSize(); x++) {
    ...
    private void drawGrid(Graphics g, int width, int height) {
        ...
        for (int i = 1; i < game.getSettings().getFieldSize(); i++) {
            int y = i * cellHeight;
